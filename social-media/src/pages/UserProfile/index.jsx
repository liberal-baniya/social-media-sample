  ...
  return (
    <>
      <div className="bg-gray-100 flex flex-col font-sfprodisplay items-center justify-end mx-auto w-full">
        <div
          className="flex md:flex-col flex-row md:gap-10 items-start
...
min-w-[103px] pr-[23px] py-[22px]"
              ...
              <div
                className="bg-white-A700 flex flex-col font-inter items-center justify-start p-[30px] sm:px-5 rounded-[12px]
w-full"
              >
                <div className="flex flex-col gap-[30px] items-center justify-start my-2.5 w-full">
                  <div className="flex flex-col gap-2.5 items-center justify-start w-[65%] md:w-full">
                    <Img
                      className="h-[108px] md:h-auto object-cover rounded-[36px]
w-[108px]"
                  ...
                  <div className="flex flex-row gap-[22px] items-center justify-center w-[71%] md:w-full">
                    <div
                      className="flex flex-row gap-[9px] items-center justify-star
t w-[42%]"
                    >
                      <Text
                    ...
                    <div
                      className="flex flex-row gap-1.5 items-start justify-start
w-[48%]"
                    >
                      <Text
...
"
          ...
          <div className="flex md:flex-1 md:flex-col flex-row font-inter gap-2.5 items-start justify-between md:px-5 w-[56%] md:w-full">
            ...
            <div
              className="sm:h-[1153px] h-[1292px] md:h-[2336px] relative
w-[99%] md:w-full"
            >
...
t w-[15%]"
                  ...
                  <div
                    className="flex flex-row font-sfprodisplay gap-5 items-cente
r justify-between w-[17%] sm:w-full"
                  >
                    <Button
...
n w-[66%]"
                      ...
                      <div className="flex flex-col items-start justify-start mt-[30px] w-full">
                        ...
                        <div className="flex flex-col gap-[15px] items-center justify-start mt-5 w-full">
                          ...
                          >
                            you are looking a the cold , take a cue : week , the
                            singer headed to warm and sunny .
                          </Text>
                        </div>
                        <Text
                        ...
                        <div className="flex flex-col gap-[15px] items-center justify-start mt-5 w-full">
                          ...
                          >
                            <span className="text-gray-500 font-inter text-left font-medium">
                              <>
                                you are looking a the cold , take a cue : week ,
                                the singer headed to warm and sunny . <br />
                              </>
                            </span>
                            <span className="text-gray-500 font-inter text-left font-medium">
...
n w-[66%]"
                      ...
                      <div className="flex flex-col items-start justify-start mt-[30px] w-full">
                        ...
                        />
                        <div
                          className="flex flex-col gap-[41px] items-start justify-star
t mt-5 w-full"
                        >
                          <Text
                            className="text-base text-gray-900"
