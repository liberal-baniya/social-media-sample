...
"
          ...
          <div
            className="bg-white-A700 flex flex-col gap-[34px] justify-en
d mt-10 sm:pl-5 pl-[30px] py-[30px] rounded-[12px] w-full"
          >
            <div
              className="flex flex-row sm:gap-10 items-start justify-between mr-[30px] mt-1 rounded-[12px] w-[96%] md:w-full
"
            >
              <Text
...
min-w-[97px]"
                ...
                variant="fill"
              >
                <div className="font-medium text-left text-sm"> more</div>
              </Button>
            </div>
            <div
              className="flex md:flex-col flex-row md:gap-5 items-center
justify-end ml-2.5 md:ml-[0] rounded-[12px] w-[99%] md:w-full"
            >
              <Button
              ...
              <div
                className="blue_A700_light_blue_200_border13 border-2 border-solid md:h-[54px] h-[65px] ml-5 md:ml-[0] pl-[5px
] py-[5px] relative rounded-[12px] w-[7%] md:w-full"
              >
                <Img
                  className="absolute h-[54px] inset-y-[0] my-auto object-cove
r right-[0] rounded-[12px] w-[88%]"
...
justify-start mt-10 w-full"
            >
              ...
              <div
                className="flex md:flex-1 flex-row font-inter gap-1.5 items-center justify-start md:ml-[0] ml-[15px] p-[5px]
w-[9%] md:w-full"
              >
                <Img
                  className="h-3.5 w-3.5"
              ...
              <Button
                className="cursor-pointer flex items-center justify-center
min-w-[75px] md:ml-[0] ml-[482px] rounded"
                rightIcon={
                  <Img
                ...
                variant="fill"
              >
                <div className="font-medium font-sfprodisplay text-left text-sm"></div>
                FGDFG
              </Button>
            </div>
          </div>
        ...
        <div className="flex flex-1 sm:flex-col flex-row gap-2.5 items-center justify-start md:ml-[0] ml-[30px] pl-[5px] md:px-5 w-full">
          ...
          <div className="bg-gray-900 flex sm:flex-1 flex-col gap-[45px] items-end justify-start p-[27px] sm:px-5 rounded-bl-[32px] rounded-tl-[32px] w-[97%] sm:w-full">
            <div className="flex flex-row gap-5 items-center justify-end mt-[18px] w-[34%] md:w-full">
              ...
              <div
                className="bg-cover bg-no-repeat h-12 relative rounded-[12px
] w-12"
...
"
              ...
              <div className="flex flex-col gap-10 items-start justify-start w-full">
                <div className="flex flex-row items-center justify-start w-full">
                  ...
                  />
                  <div
                    className="flex flex-row items-start justify-center ml-2.5
py-0.5 w-[43%]"
                  >
                ...
                >
                  <div className="flex flex-col items-center justify-start w-full">
                    <div className="flex flex-col gap-5 justify-start w-full">
                      ...
                      <Button
                        className="cursor-pointer flex items-center justify-center
min-w-[80px] md:ml-[0] ml-[38px] mr-[197px] rounded
"
                        leftIcon={
                          <Img
                            className="h-3.5 ml-2.5 mr-1 my-2"
...
"
                ...
                <div
                  className="flex flex-row items-start justify-end md:ml-[0]
ml-[18px] w-[95%] md:w-full"
                >
                  <Img
