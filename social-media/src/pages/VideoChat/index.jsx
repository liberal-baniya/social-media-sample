...
mx-auto w-full"
      >
        ...
        <div
          className="flex flex-1 md:ml-[0] ml-[5px] md:px-5 relative
w-full"
        >
            ...
            >
              <div className="flex flex-row font-sfprodisplay items-center justify-between w-[97%] md:w-full">
                <div className="flex flex-col items-center justify-start">
                  <div
                    className="flex flex-row gap-[15px] items-end justify-betwee
n w-full"
                  >
                    <div
                    ...
                    <div
                      className="flex flex-col gap-[13px] items-start justify-star
t mt-[5px]"
                    >
                      <Text
...
t mt-11 pb-[3px] pr-[3px] w-[84%] md:w-full"
                >
                  <Img
                    className="h-[38px] md:h-auto object-cover rounded-[12px] w-[38px]"
                    src="images/img_avatar_48X48.png"
...
mb-1.5 w-[79%]"
                ...
                <div
                  className="flex flex-row items-center justify-start mt-[35px
] w-[29%] md:w-full"
                >
                  <Img
                    className="h-[38px] md:h-auto object-cover rounded-[12px] w-[38px]"
                  ...
                  <div
                    className="bg-gray-500_33 h-[7px] mb-[9px] ml-[5px] mt-[22px
] rounded-[50%] w-[7px]"
                  ></div>
                </div>
              </div>
