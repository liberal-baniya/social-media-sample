      ...
      <div className="bg-gray-100 flex flex-col font-inter items-center justify-end mx-auto w-full">
        <div className="flex md:flex-col flex-row gap-[35px] items-start justify-between w-full">
          <div className="flex flex-1 md:flex-col flex-row md:gap-10 items-start justify-between mx-auto md:px-5 w-full">
            ...
            <div
              className="flex flex-1 flex-col md:gap-10 gap-16 items-cente
r justify-start md:mt-0 mt-10 w-full"
            >
              <div
                className="flex flex-col md:gap-10 gap-[66px] items-center
                ...
                <div className="flex flex-col items-start justify-start w-full">
                  ...
                  <div className="flex flex-col items-center justify-start mt-10 w-full">
                    <div className="md:gap-5 gap-[30px] grid md:grid-cols-1 grid-cols-2 justify-center min-h-[auto] w-full">
                      <div
                        className="bg-white-A700 flex flex-1 flex-row items-center
justify-between p-[30px] sm:px-5 rounded-[12px] w-full"
                      >
                        <div
                          className="flex flex-row gap-[15px] items-end justify-center
"
                        >
                          <Img
...
t w-full"
              >
                ...
                <div className="flex md:flex-col flex-row gap-[30px] items-start justify-between w-full">
                  <div
                    className="bg-white-A700 flex md:flex-1 flex-col items-cente
r justify-start p-[30px] sm:px-5 rounded-[12px] w-[49%] md:w-full"
                  >
                    <div
...
t p-[5px] w-[22%]"
                  ...
                  <div
                    className="bg-white-A700 flex md:flex-1 flex-col items-cente
r justify-start mb-[124px] p-[23px] sm:px-5 rounded-[12px] w-[49%] md:w-full"
                  >
          ...
          <div className="flex md:flex-1 sm:flex-col flex-row font-sfprodisplay gap-2.5 items-center justify-between md:px-5 w-[29%] md:w-full">
            ...
            <div className="bg-gray-900 flex flex-col gap-[45px] items-end justify-start p-10 sm:px-5 rounded-bl-[32px] rounded-tl-[32px]">
              ...
              <div className="flex flex-col font-inter items-center justify-start mb-0.5 w-[99%] md:w-full">
                <div
                  className="bg-red-A200 h-[174px] pt-5 relative rounded-[12px
] w-full"
                >
                  ...
                  <div
                    className="flex flex-col gap-[25px] items-start justify-star
t mb-[undefinedpx] mt-auto mx-auto w-[85%] z-[1]"
                  >
                    <Text
                    ...
                    >
                      <>
                        premium membership and enjoy
                        <br />a full experience our community .
                      </>
                    </Text>
                    <Button
                      className="cursor-pointer flex items-center justify-center
...
justify-center min-w-[90px]"
                ...
                <div
                  className="flex flex-col gap-[45px] items-start justify-star
t mt-[60px] w-full"
                >
                  <Text
                    className="text-[22px] sm:text-lg text-white-A700 md:text-xl
...
w-full"
                    >
                      ...
                      <Button
                        className="flex h-7 items-center justify-center ml-[134px]
