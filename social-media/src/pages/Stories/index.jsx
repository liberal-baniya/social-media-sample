    ...
    <>
      <div className="bg-gray-100 flex sm:flex-col md:flex-col flex-row font-inter sm:gap-5 md:gap-5 items-start mx-auto w-full">
        ...
        <div className="flex flex-1 md:flex-col flex-row gap-2.5 items-start justify-between mx-auto md:px-5 w-full">
          ...
          <div
            className="bg-gray-900 flex flex-col items-center justify-en
d pt-10 px-10 sm:px-5 rounded-bl-[32px] rounded-tl-[32px]"
          >
            <div
              className="flex flex-col items-start justify-start w-[98%]
md:w-full"
            >
...
"
                ...
                <div
                  className="flex md:flex-1 flex-row font-sfprodisplay gap-5
items-center justify-between w-[11%] md:w-full"
                >
                  <Button
...
t w-[10%] sm:w-full"
                ...
                <div
                  className="flex flex-col items-center justify-start sm:ml-[0
] ml-[26px] sm:mt-0 mt-0.5"
                >
                  <Text
              ...
              <div className="flex flex-col font-sfprodisplay items-center justify-start mt-10 w-full">
                <div className="gap-10 md:gap-5 grid sm:grid-cols-1 md:grid-cols2 grid-cols-4 justify-center min-h-[auto] w-full">
                  <div
                  ...
                  >
                    <div
                      className="bg-gradient flex flex-col gap-[18px] items-cente
r justify-end p-[42px] md:px-10 sm:px-5 rounded-lg w-full"
                    >
                      <Img
...
r justify-end p-[42px] md:px-10 sm:px-5 rounded-lg w-full"
                  ...
                  >
                    <div
                      className="bg-gradient flex flex-col gap-[15px] items-cente
r justify-end p-10 sm:px-5 rounded-lg w-full"
                    >
                      <Img
