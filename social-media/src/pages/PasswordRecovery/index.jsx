      ...
      <div className="bg-gray-100 flex font-inter mx-auto relative w-full">
        ...
        >
          <div className="flex flex-col items-center justify-start my-[130px] w-full">
            ...
            <Button
              className="common-pointer cursor-pointer font-bold min-w-[220px] mt-[30px] py-[21px] rounded-[29px] text-cente
r text-sm"
              onClick={() => navigate("/")}
              color="indigo_A200"
              variant="fill"
...
z-[1]"
        >
          ...
          <div
            className="bg-white-A700 flex flex-col items-start justify-start p-[90px] md:px-10 sm:px-5 rounded-bl-[32px]
rounded-tl-[32px]"
          >
            <div
              className="flex flex-col items-start justify-start mb-[468px
] md:ml-[0] ml-[35px] w-[77%] md:w-full"
            >
              <Img
...
"
              ...
              <Button
                className="cursor-pointer font-bold min-w-[350px] mt-5 py-[22px] rounded-[29px] text-center text-sm"
                color="indigo_A200"
                variant="fill"
              >
                Send Email
