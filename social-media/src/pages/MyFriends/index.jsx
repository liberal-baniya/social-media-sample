...
y gap-2.5 items-center justify-start md:ml-[0] ml-[30px] pl-[5px] md:px-5 w-full"
        >
          ...
          <div className="bg-gray-900 flex sm:flex-1 flex-col gap-[49px] justify-end p-[30px] sm:px-5 rounded-bl-[32px] rounded-tl-[32px] w-[97%] sm:w-full">
            ...
            <div
              className="flex flex-col font-inter gap-[43px] items-start
justify-start md:ml-[0] ml-[15px] mr-5 w-[90%] md:w-full"
            >
              <Text
