...
r justify-start p-[30px] sm:px-5 rounded-[12px] w-[47%] md:w-full"
                    >
                      <div
...
t p-1.5 w-[23%]"
                    ...
                    <div className="bg-white-A700 flex md:flex-1 flex-col font-sfprodisplay items-center justify-end mb-[30px] p-[30px] sm:px-5 rounded-[12px] w-1/2 md:w-full">
                      <div className="flex flex-col gap-8 items-start justify-start mt-[3px] w-full">
                        ...
                        <div
                          className="flex flex-col font-inter gap-[30px] items-start
justify-start w-full"
                        >
                          <div className="flex flex-col gap-2.5 h-80 items-center justify-start rounded-[12px] w-80">
                            <div
                              className="flex flex-row gap-2.5 items-center justify-betwee
n rounded-[12px] w-full"
                            >
                              <Img
                                className="h-[100px] md:h-auto object-cover rounded-[12px]
w-[100px]"
...
min-w-[97px] rounded"
                  ...
                  <div className="flex flex-1 md:flex-col flex-row gap-[30px] items-start justify-between my-0 w-full">
                    <div
                      className="bg-white-A700 flex md:flex-1 flex-col items-cente
r justify-start md:mt-0 mt-[30px] p-[30px] sm:px-5 rounded-[12px] w-[47%] md:w-full"
                    >
                      <div
                        className="flex flex-row items-center justify-between w-full
"
...
t p-[5px] w-[23%]"
                    ...
                    <div
                      className="bg-white-A700 flex md:flex-1 flex-col font-sfprodisplay items-center justify-end mb-[173px] p-[30px
] sm:px-5 rounded-[12px] w-[380px] md:w-full"
                    >
