...
min-w-[180px] pr-[35px] py-[22px]"
                        ...
                        variant="outline"
                      >
                        <div className="!text-red-A200 font-bold font-sfprodisplay sm:pr5 text-left text-sm">
                          Delete
                        </div>
                      </Button>
                    </div>
              ...
              <div
                className="flex flex-col items-center justify-start mt-[33px
] pt-[3px] w-full"
              >
...
"
          ...
          <div className="flex md:flex-1 sm:flex-col flex-row gap-2.5 items-center justify-start pl-[5px] md:px-5 w-[36%] md:w-full">
            ...
            <div
              className="bg-gray-900 flex flex-col gap-[45px] justify-star
t p-10 sm:px-5 rounded-bl-[32px] rounded-tl-[32px] w-[98%] sm:w-full"
            >
              <div className="h-12 md:h-[53px] md:ml-[0] ml-[299px] mt-[5px] relative w-[28%]">
                ...
                />
                <div
                  className="common-pointer bg-light_blue-200 flex flex-col h-full items-center justify-start my-auto p-[13px]
rounded-[12px] w-12"
...
"
                ...
                <div className="absolute flex flex-row font-sfprodisplay gap-5 h-full inset-[0] items-center justify-between m-auto w-full">
                  <Button
                    className="cursor-pointer font-bold h-12 sm:text-[18.32px]
md:text-[20.32px] text-[22.32px] text-center w-12"
                    shape="round"
                    color="light_blue_200"
                    size="2xl"
                    variant="fill"
...
"
                ...
                <div
                  className="flex flex-col font-sfprodisplay gap-10 items-star
t justify-start w-full"
                >
