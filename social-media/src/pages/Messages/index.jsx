    ...
    <>
      <div className="bg-gray-100 flex flex-col font-sfprodisplay items-center justify-start mx-auto w-full">
        <div className="flex md:flex-col flex-row md:gap-[52px] items-center justify-between w-full">
          <div
            className="flex md:flex-1 sm:flex-col flex-row sm:gap-10 items-start justify-between md:px-5 w-[41%] md:w-full
"
          >
...
0 18 18"
                ...
                <div className="flex flex-col gap-10 items-start justify-start w-full">
                  ...
                  <div
                    className="flex flex-row font-inter items-start justify-star
t w-[84%] md:w-full"
                  >
                    <div
...
mb-[3px] mt-[7px]"
                    >
                      ...
                      >
                        Thank you for sharing you sharing
                      </Text>
                    </div>
                  </div>
