...
w-full"
          >
            <div
              className="bg-white-A700 flex sm:flex-col flex-row gap-[13px
] items-center justify-start p-3 rounded-[12px] w-full"
            >
              <Input
                name="FrameOne"
...
"
            ...
            <div className="flex md:flex-col flex-row gap-[30px] items-center justify-between w-full">
              <div
                className="flex md:flex-1 flex-col gap-[30px] items-center
justify-start w-1/2 md:w-full"
              >
                <div
                  className="bg-white-A700 flex flex-col gap-[7px] items-cente
r justify-start p-[30px] sm:px-5 rounded-[12px] w-full"
                >
...
"
                  ...
                  <div className="flex flex-row items-start justify-start w-full">
                    ...
                    <Button
                      className="flex h-7 items-center justify-center ml-2.5 mt-0.
5 rounded-lg w-7"
                      color="gray_100"
                      size="lg"
                      variant="fill"
...
min-w-[75px] ml-[141px] rounded"
                      ...
                      variant="fill"
                    >
                      <div className="font-medium text-left text-sm"> </div>
                    </Button>
                  </div>
                </div>
                <div
                ...
                >
                  <div
                    className="flex flex-col items-center justify-start mt-[22px
] w-[88%] md:w-full"
                  >
                    <div
...
"
                    >
                      <div
                        className="flex flex-row gap-2.5 items-center justify-betwee
n w-1/2"
                      >
                        <Img
                    ...
                    <div className="flex flex-col gap-5 items-center justify-start mt-[34px] w-full">
                      ...
                      >
                        <div
                          className="bg-gray-900_66 flex flex-col items-center justify-start p-[71px] md:px-10 sm:px-5 rounded-lg w-full
"
                        >
                          <Button
...
n w-[44%]"
                      >
                        <div
                          className="flex flex-row gap-[5px] items-center justify-star
t p-1.5 w-[48%]"
                        >
                          <Img
...
w-full"
                        >
                          <div
                            className="flex flex-row items-end justify-between w-[98%]
md:w-full"
                          >
                          ...
                          >
                            Awesome Edward , remeber that five tips low cost
                            holidays sent you ?
                          </Text>
...
w-full"
                      >
                        <div className="flex flex-col items-start justify-start w-full">
                          <div
                            className="flex flex-row items-end justify-between w-[99%]
md:w-full"
                          >
                            <div className="flex flex-row items-end justify-evenly">
                              <Img
                  ...
                  <div className="flex flex-col items-start justify-start mt-[30px] w-full">
                    ...
                    <div className="flex flex-col gap-[15px] items-center justify-start mt-5 w-full">
                      ...
                      >
                        ...
                        Disneyland warm and sunny California
                      </Text>
                    </div>
                    <Text
                      className="mt-3 text-indigo-A200 text-xs tracking-[1.00px]
uppercase"
...
t p-1.5 w-[23%]"
                ...
                <div className="bg-white-A700 flex flex-col items-center justify-start p-[23px] sm:px-5 rounded-[12px] w-full">
                  <div className="flex flex-col gap-[25px] items-center justify-start my-[7px] w-[98%] md:w-full">
                    <div
                      className="flex flex-col gap-[30px] items-start justify-star
t w-[98%] md:w-full"
                    >
                      <div
                        className="flex flex-row items-center justify-between w-full
...
t p-[5px] w-[48%]"
        ...
        <div
          className="flex flex-1 sm:flex-col flex-row font-sfprodispla
y gap-2.5 items-center justify-between md:ml-[0]
ml-[30px] overflow-auto pl-[5px] md:px-5 w-full"
        >
          ...
          <div className="sm:h-[1022px] h-[1024px] md:h-[815px] relative w-full">
            <div className="absolute bg-gray-900 flex flex-col md:gap-10 gap-[227px] h-full inset-y-[0] justify-end left-[0] my-auto p-[30px] sm:px-5 rounded-bl-[32px] rounded-tl-[32px] w-[93%]">
              ...
              <div
                className="flex flex-col font-inter md:gap-10 gap-[60px] items-center justify-start md:ml-[0] ml-[15px] mr-5
w-[90%] md:w-full"
              >
                <div
                  className="flex flex-col gap-[43px] items-start justify-star
t w-full"
                >
                  <Text
                ...
                <div className="flex flex-col gap-10 items-start justify-start w-full">
                  ...
                  >
                    ...
                    <div className="flex flex-1 flex-row items-center justify-start w-full">
                      ...
                      <Button
                        className="flex h-7 items-center justify-center ml-[124px]
my-[5px] rounded-lg w-7"
                        color="white_A700_33"
                        size="lg"
                        variant="fill"
                      >
