...
const SingleVideoPage = () => {
  ...
  return (
    <>
      <div
        className="bg-gray-100 flex sm:flex-col md:flex-col flex-row font-sfprodisplay sm:gap-5 md:gap-5 items-start
mx-auto w-full"
      >
        ...
        <div className="flex-1 h-[1024px] sm:h-[1308px] md:h-[1610px] md:px-5 relative w-full">
          ...
          <div className="absolute flex flex-col gap-[42px] h-max inset-y-[0] items-center justify-start left-[7%] my-auto w-1/2">
            <div className="flex flex-col gap-10 items-start justify-start w-full">
              <Button
                className="common-pointer cursor-pointer flex items-center
justify-center min-w-[103px] pr-[23px] py-[22px]"
                ...
                variant="fill"
              >
                <div className="font-bold sm:pr-5 text-left text-sm"> </div>
              </Button>
                ...
                >
                  <div className="flex flex-col gap-[18px] items-center justify-start mt-64 pt-[3px] w-full">
                    <div className="flex flex-col items-center justify-start w-full">
                      <div
                        className="flex flex-col gap-[9px] items-center justify-star
t w-full"
                      >
                ...
                <div className="flex sm:flex-col flex-row sm:gap-10 items-center justify-between w-full">
                  <div
                    className="flex sm:flex-1 flex-col items-center justify-star
t w-[24%] sm:w-full"
                  >
                    <div
                      className="flex flex-row gap-2.5 items-end justify-between
w-full"
                    >
                      <Img
...
t mt-1 p-1.5"
                    ...
                    <div
                      className="flex flex-row items-center justify-end mt-[3px]
p-1.5"
                    >
                      <Img
                ...
                <div className="flex flex-col gap-2 items-start justify-start w-full">
                  <div className="flex flex-col gap-5 items-center justify-start w-full">
                    ...
                    >
                      is back , better than ever! a hundred resorts have
                      reopened and th e state tourism minister predicts will
                      draw as many visitors as it did two years ago . the travel
                      deals are great! you haven t been , now may be the best
                      time to take a vacation to .
                    </Text>
                  </div>
                  <div className="flex flex-row gap-2.5 items-center justify-start w-[59%] md:w-full">
                    <Button
                      className="cursor-pointer min-w-[52px] rounded text-center
text-xs"
                      color="gray_500_48"
                      size="sm"
                      variant="fill"
                    ...
                    <Button
                      className="cursor-pointer min-w-[57px] rounded text-center
text-xs"
                      color="gray_500_48"
                      size="sm"
                      variant="fill"
                    ...
                    <Button
                      className="cursor-pointer min-w-[65px] rounded text-center
text-xs"
                      color="gray_500_48"
                      size="sm"
                      variant="fill"
                    ...
                    <Button
                      className="cursor-pointer min-w-[60px] rounded text-center
text-xs"
                      color="gray_500_48"
                      size="sm"
                      variant="fill"
            ...
            <div
              className="flex flex-col font-inter gap-[23px] items-start
...
md:w-full"
                      ...
                      >
                        , remeber that five tips low cost holidays sent you ?
                      </Text>
...
md:w-full"
                      ...
                      <Text
                        ...
                        size="txtInterRegular14WhiteA700"
                      >
                        , remeber that five tips low cost{" "}
                      </Text>
                      <div className="flex flex-row gap-4 items-center justify-start w-[14%] md:w-full">
                        <Img
                          className="h-3.5 w-3.5"
