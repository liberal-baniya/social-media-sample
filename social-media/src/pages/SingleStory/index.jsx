...
justify-center min-w-[103px] pr-[23px] py-[22px]"
                ...
                <div className="bg-gray-900_6c border-2 border-gray-500_6c border-solid flex flex-col font-inter items-center justify-start p-[9px] rounded w-[78%] md:w-full">
                  <div
                    className="flex sm:flex-col flex-row sm:gap-5 items-center
...
a comment…"
              ...
              <div
                className="flex md:flex-1 flex-col items-center justify-star
t w-[35%] md:w-full"
              >
...
r justify-end md:ml-[0] ml-[204px] mt-[5px] w-[37%
] md:w-full"
                  >
                    <Button
