...
"
        ...
        <div className="flex md:flex-1 md:flex-col flex-row font-inter gap-2.5 items-start justify-between md:px-5 w-[56%] md:w-full">
          ...
          <div
            className="h-[1070px] md:h-[1880px] sm:h-[2828px] relative
w-[99%] md:w-full"
          >
            <div className="absolute bg-white-A700 flex sm:flex-col flex-row sm:gap-10 inset-x-[0] items-center justify-between mx-auto p-10 sm:px-5 rounded-bl-[32px] rounded-tl-[32px] top-[0] w-full">
              <div
                className="flex sm:flex-1 flex-row items-start justify-cente
r ml-2.5 sm:ml-[0] pt-0.5 w-[39%] sm:w-full"
              >
                <Text
...
t ml-[31px] w-[18%]"
              ...
              <div
                className="flex sm:flex-1 flex-row font-sfprodisplay gap-5
items-center justify-center mb-[891px] sm:mt-0 mt-[5px] w-[17%] sm:w-full"
              >
                <Button
            ...
            >
              <div className="gap-4 grid sm:grid-cols-1 md:grid-cols-2 grid-cols-3 items-center justify-between my-0 rounded-[12px] w-full">
                <Img
                  className="h-[221px] md:h-auto object-cover rounded-[12px]
w-[221px]"
...
w-[221px]"
              ...
              <div className="gap-4 grid sm:grid-cols-1 md:grid-cols-2 grid-cols-3 items-center justify-between my-0 rounded-[12px] w-full">
                <Img
                  className="common-pointer h-[221px] md:h-auto object-cover
rounded-[12px] w-[221px]"
                  src="images/img_photo3.png"
                  alt="Image One"
                  onClick={() => navigate("/singlephoto")}
                />
                <Img
                  className="h-[221px] md:h-auto object-cover rounded-[12px]
w-[221px]"
