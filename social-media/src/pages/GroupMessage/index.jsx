...
0 18 18"
              ...
              >
                ...
                <div
                  className="bg-white-A700 flex flex-1 flex-col items-center
justify-start p-5 rounded-[12px] w-full"
                >
...
t mt-0.5"
                      >
                        <div
                          className="flex flex-row items-start justify-start w-[53%]
md:w-full"
                        >
                          <Text
                            className="text-gray-900 text-sm"
...
n rounded-lg w-full"
                ...
                <div
                  className="flex flex-col items-center justify-start mt-[49px
] w-[95%] md:w-full"
                >
                  <div className="flex flex-row gap-[15px] items-start justify-between w-full">
                    <Img
...
t mt-[49px] pb-[3px] pr-[3px] w-[79%] md:w-full"
                >
                  <Img
                    className="h-[38px] md:h-auto object-cover rounded-[12px] w-[38px]"
                    src="images/img_avatar_48X48.png"
