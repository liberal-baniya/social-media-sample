...
const UserProfile = React.lazy(() => import('pages/UserProfile')); // Corrected casing
const MyFriends = React.lazy(() => import('pages/MyFriends')); // Corrected file path
...
const SingleVideo = React.lazy(() => import('pages/SingleVideo')); // Corrected name to match import
const SinglePost = React.lazy(() => import('pages/SinglePost'));
const SingleStory = React.lazy(() => import('pages/SingleStory'));
const Stories = React.lazy(() => import('pages/Stories'));
const Home1 = React.lazy(() => import('pages/Home1')); // Corrected name for consistency
